...
# model_1_resource="+resource.n_gpus_per_node=$GPU_num  +$model_1_config_path.trainer.n_gpus_per_node=$GPU_num $model_1_config_path.trainer.nnodes=1 +$model_1_config_path.actor_rollout_ref.rollout.tensor_model_parallel_size=$GPU_num"
...
python -m pettingllms.trainer.train \
    ...
    training.experiment_name=math_1.7B_L3\
    training.total_training_steps=200\
    training.epoch_size=20\
    training.train_batch_size=4\
    training.train_sample_num=2\
