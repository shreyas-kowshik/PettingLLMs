...
AGENT_CLASSES = {
    ...
    "code_mbpp": safe_import("pettingllms.multi_agent_env.code.agents.code_mbpp_agent", "CodeMBPPAgent"),
    "code_with_example_mbpp": safe_import("pettingllms.multi_agent_env.code.agents.code_with_example_mbpp_agent", "CodeWithExampleMBPPAgent"),
